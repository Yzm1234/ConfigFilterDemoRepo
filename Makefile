...
SERVICE_CAPS = ziming_yang_1ConfigFilterApplicationDemo
SPEC_FILE = ziming_yang_1ConfigFilterApplicationDemo.spec
URL = https://kbase.us/services/ziming_yang_1configfilterapplicationdemo
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
